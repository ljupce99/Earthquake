    ...
    <header style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 20 }}>
        <div style={{ textAlign: 'center' }}>
          <div style={{ fontSize: 9, color: 'var(--text-dim)', letterSpacing: '0.12em' }}>EVENTS</div>
          <div style={{ fontSize: 18, fontWeight: 500, color: 'var(--accent)', lineHeight: 1.2 }}>{total}</div>
        </div>
        <div style={{ width: 1, height: 32, background: 'var(--border)' }} />
        <div style={{ textAlign: 'center' }}>
          <div style={{ fontSize: 9, color: 'var(--text-dim)', letterSpacing: '0.12em' }}>LAST SYNC</div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
          ...
          <span style={{ fontSize: 10, color: 'var(--text-dim)', letterSpacing: '0.1em' }}>LIVE</span>
        </div>
      </div>
